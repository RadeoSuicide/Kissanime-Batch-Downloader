...
var rootUrl = 'https://kisscartoon.es'
var URL = window.location.origin
// END CONFIG


var episodeLinks = $('full a').map(function(i,el) { return $(el).attr('href'); });
var episodeNames = $('full a').map(function(i,el) { return $.trim( $(el).html() ); });
